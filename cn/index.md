...
<div class="profile-header">
    ...
    <div class="profile-info">
        ...
        <div class="profile-text-line">
            <span class="profile-label">地址:</span> 浙江大学玉泉校区逸夫工商管理楼402
        </div>
    </div>
</div>

## 研究方向
- **芯片安全**：芯片安全架构、RISC-V处理器安全、密码运算性能及面积优化
- **大模型推理优化及安全研究**
- **智能网联车安全**：AI驱动的漏洞挖掘与合规检测、入侵检测与主动防御、智驾模型安全
...
## 招生
招收计算机科学与技术/网络空间安全/电子信息(网络与信息安全)专业的研究生(博士/硕士)，同时欢迎优秀的本科生到我的课题组做暑期实习和毕业设计。欢迎对芯片安全、软硬件系统安全和智能网联汽车安全感兴趣的同学与我联系。优秀的毕业生可推荐到海外知名高校继续深造或业内顶尖科技公司工作。
